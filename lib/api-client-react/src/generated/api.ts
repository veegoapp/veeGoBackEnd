 ...
 */
export const listVehicles = async (params?: ListVehiclesParams, options?: RequestInit): Promise<VehiclesPage> => {

  return customFetch<VehiclesPage>(getListVehiclesUrl(params),
  {
    ...options,
    method: 'GET'
