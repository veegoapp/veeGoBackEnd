...
import { shuttleVehicleTypesTable } from "./shuttleVehicleTypes";
...
export const busesTable = pgTable("buses", {
  ...
  vehicleTypeId: integer("vehicle_type_id").references(() => shuttleVehicleTypesTable.id, { onDelete: "set null" }),
