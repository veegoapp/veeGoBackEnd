...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const navGroups = useMemo((): NavGroup[] => [
    ...
    },
    {
      ...
      items: [
        { title: t("nav.customers"), href: "/customers", icon: Users },
        {
          ...
          subItems: [
            { title: t("nav.pendingVerification"), href: "/drivers/pending", icon: Clock },
          ],
        },
        {
          title: t("nav.trips"), href: "/trips", icon: Navigation,
          subItems: [
            { title: t("nav.live"), href: "/trips/live", icon: Radio },
            { title: t("nav.bookings"), href: "/trips/bookings", icon: Ticket },
          ],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: t("nav.services"), href: "/services/car", icon: Layers,
          subItems: [
            { title: t("nav.cars"), href: "/services/car", icon: Car },
            { title: t("nav.shuttle"), href: "/services/shuttle", icon: Bus },
            { title: t("nav.motorcycles"), href: "/services/bike", icon: Bike },
            { title: t("nav.delivery"), href: "/services/delivery", icon: PackageOpen, comingSoon: true },
          ],
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          title: t("nav.payments"), href: "/payments/transactions", icon: Wallet,
          subItems: [
            { title: t("nav.transactions"), href: "/payments/transactions", icon: CreditCard },
            { title: t("nav.wallets"), href: "/payments/wallets", icon: Wallet },
            { title: t("nav.payouts"), href: "/payments/payouts", icon: ArrowUpRight },
            { title: t("nav.commission"), href: "/payments/commission", icon: Percent },
          ],
        },
      ],
    },
    {
      ...
      items: [
        { title: t("nav.complaints"), href: "/complaints", icon: MessageSquare },
        { title: t("nav.notifications"), href: "/notifications", icon: Bell },
        {
          title: t("nav.reports"), href: "/reports/revenue", icon: BarChart3,
          subItems: [
